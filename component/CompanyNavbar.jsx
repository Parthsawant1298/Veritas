...
import { Menu, X, Building2, User, LogOut, ChevronDown } from 'lucide-react';
...
const CompanyNavbar = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      console.error('Company logout failed:', error);
    }
  };

  // Dynamic navigation based on auth status
  const navLinks = company ? [
    { name: 'Home', href: '/company-main' },
          ...
          {isLoading ? (
            ...
            <div className="relative profile-menu-container">
              ...
              >
                ...
                <span className="font-medium text-sm">{company.name?.split(' ')[0]}</span>
                <ChevronDown
                  size={16}
